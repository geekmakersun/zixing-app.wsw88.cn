...
INSERT INTO `dr_1_product_search` VALUES ('7570fce05e5a585ef0ffa2da8916cc48',2,'{\"param\":{\"catid\":2},\"sql\":\"SELECT `dr_1_product`.`id` FROM `dr_1_product`  ORDER BY NULL \",\"where\":\"\"}','',6,1758853596),('8228f9e0847848bb550c15a63bf3bdc4',5,'{\"param\":{\"catid\":5},\"sql\":\"SELECT `dr_1_product`.`id` FROM `dr_1_product`  ORDER BY NULL \",\"where\":\"\"}','',6,1758853597),('90df29dcb37d481c6d6f67a392aa2429',4,'{\"param\":{\"catid\":4},\"sql\":\"SELECT `dr_1_product`.`id` FROM `dr_1_product`  ORDER BY NULL \",\"where\":\"\"}','',6,1758853596),('e224b0f2777213a8bacb89df1964b08a',3,'{\"param\":{\"catid\":3},\"sql\":\"SELECT `dr_1_product`.`id` FROM `dr_1_product`  ORDER BY NULL \",\"where\":\"\"}','',6,1758853596);
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='登录日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-09-26 11:15:10
