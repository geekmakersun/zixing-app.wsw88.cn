...
<div id="kt_app_footer" class="app-footer">
    ...
    <div class="app-container container-xxl d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
        ...
        <div class="text-dark order-2 order-md-1">
            ...
            <span data-action="site_param" class="tpl-edit-show text-muted fw-semibold me-1"><?php echo SITE_NAME; ?></span>
            <?php if (SITE_ICP) { ?>
            <span data-action="site_param" class="tpl-edit-show text-muted fw-semibold me-1"><a href="https://beian.miit.gov.cn/" target="_blank"><?php echo SITE_ICP; ?></a></span>
            <?php } ?>
        </div>
        <!--end::Copyright-->
        <!--begin::Menu-->
