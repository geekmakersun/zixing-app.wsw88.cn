    ...
    <div class="col-xl-4">
        ...
        <div data-action="site_param:yqlj" class="tpl-edit-show card card-flush mt-10">
            ...
            <div class="card-body pt-3">
                ...
                <div class="d-flex flex-stack">
                    <!--begin::Section-->
                    <a href="<?php echo dr_html2code($v[2]); ?>" target="_blank" class="text-primary fw-semibold fs-6 me-2"><?php echo dr_html2code($v[1]); ?></a>
                    <!--end::Section-->
                    <!--begin::Action-->
                    <a href="<?php echo dr_html2code($v[2]); ?>" target="_blank" class="btn btn-icon btn-sm h-auto btn-color-gray-400 btn-active-color-primary justify-content-end">
